...
(function () {
  ...
  var DB_DEFS = [
    ...
    ['net-ice', 'Net · ICE (fort defense)', 'data/net-ice.json', false],
    ['net-capabilities', 'Net · Capabilities', 'data/net-capabilities.json', false],
    ['net-buildtables', 'Net · Program build [BWB]', 'data/net-buildtables.json', false],
